...
namespace UnityEditor.Tilemaps
{
    internal class TilePaletteActivePaletteDropdownMenu : IGenericMenu
    {
        ...
        public TilePaletteActivePaletteDropdownMenu(int parentWidth)
        {
            ...
            m_Dropdown = new GridPalettesDropdown(menuData, index, null, SelectPalette, HoverPalette, Mathf.Max(parentWidth, k_DropdownWidth));
        }
